...
const CartNotification: React.FC<CartNotificationProps> = ({ isVisible, productName, quantity }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-[#C8B6A6] text-white p-4 rounded-lg shadow-lg z-50 animate-fade-in">
      <p className="mb-2">
        {quantity}x {productName} {getLocalizedText('cartNotification.addedToCart')}
      </p>
      <Link 
